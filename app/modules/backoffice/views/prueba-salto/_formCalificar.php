...
?>
<div class="col-md-1"><?= $row->orden_participacion ?></div>
<div class="col-md-1"><?= $row->caballoHasJinete->jinete->nombre_completo ?></div>
...
<div class="col-md-1">
    ...
    <?= $form->field($row, 'id_resultado_salto')->hiddenInput()->label(false) ?>
</div>
